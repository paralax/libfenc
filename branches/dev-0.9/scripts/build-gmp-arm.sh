...
CFL="--sysroot /Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS3.1.3.sdk -fnested-functions -I$SDK_HDRS"

#./configure --prefix=/test/ --host=arm-mac-linux-gnu CC="$SDK_CC" M4="/usr/local/bin/m4"
#./configure --prefix=/test/ --build=pentiumm-apple-darwin10.2.0 --host=arm-apple-darwin9 CC="$SDK_CC" CFLAGS="$CFL"
# -DNO_ASM
#--disable-shared

# Replace a file.
echo "dnl  ARM mpn_invert_limb -- Invert a normalized limb.
...
ASM_END()" > mpn/arm/invert_limb.asm


./configure CC="/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc-4.2" CPP="/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc-4.2 -E" LD="/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/ld" CPPFLAGS="-arch armv6 -isysroot /Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS3.0.sdk -miphoneos-version-min=3.0" --disable-shared --enable-static --prefix=/iPhoneOS-build/ --host=arm-apple-darwin9
